    ...
    <>
      <section className="bg-1900">
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <p>
                ...
                name “EMPERIA 1900″. <br /><br /> The technology is enabled by smart action
                techniques for cleaning surfaces. This technology employs a
                technically designed surfactant that works on the fundamental
                principle of “like attracts like”. This suggests that the polar
                head group is water-loving and the long hydrophobic hydrocarbon
                tail is water-repelling. This techno-enabled surfactant is smart
                enough for all types of stains, dirt and soil.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container info">
          ...
          <h5 className="headline fw-bold">Surfactants</h5>
          <p>
            ...
            structure possesses a polar group that is “water-loving” and called
            a “hydrophilic head” and another non-polar group that is
            “water-repelling” (or oil loving) which is denoted as a “hydrophobic
            tail”. Generally, the polar head group is composed of
            ...
            processes. Due to their dual nature, they are helpful in decreasing
            the interfacial tension (also called surface tension) between two
            phases.
          </p>
          ...
          <h2>Factors Affecting Cleaning:</h2>
          <h5 className="headline fw-bold">Surface Tension</h5>
          <p>
          ...
          <h5 className="headline fw-bold">Hydrophilic - Lipophilic Balance</h5>
          <p>
        ...
        <div className="container">
          <div className="row info">
            <div className="col-md-6">
              <h5 className="headline fw-bold">Essential need for Cleaning</h5>
              <ol type="number">
                <li>
                  <span  className="fw-bold">SURFACTANT</span>: Based on the charge on its head group it is
                  classified as cationic, anionic, non-ionic and amphoteric.
                </li>
                <li>
                  <span className="fw-bold">HYDROTROPES</span>: It is usually used to increase the solubility of
                  surfactant.
                </li>
                <li>
                  <span className="fw-bold">CHELATOR</span>: It entraps the hard water elements from the water
                  and smoothen the cleaning action.
                </li>
                <li>
                  <span className="fw-bold">BUILDER</span>: Helps in emulsifying and dispersion of dirt molecules
                  and prevents its redeposit ion.
                </li>
                <li>
                  <span className="fw-bold">CARRIERS</span>: Helps in the final step of cleaning in decomposing
                  or entrapment of dirt/soil particles.
                </li>
              </ol>
            </div>
            <div className="col-md-6 justify-centent-center">
              <img src="media/surfactant.png" alt="" className="img-fluid p-5" />
            </div>
          </div>
        </div>

        <div className="container info pb-3">
          <h5 className="headline fw-bold">Micellar Formation and Cleaning Action</h5>
          <p>
          ...
          <img style={{width:"100%"}}
            src="media/For.jpg"
            alt=""
            className="image-fluid ms-auto img-fluid"
          />
          <p>
            Empire Industries Limited strives to be a company that calibrates
            the standard of excellence and makes a positive impact on the
            environment and communities, it serves. EMPERIA 1900 envisions
            promoting public health and contributing to making a meaningful
            difference in the lives of individuals and communities. This has led
            us to work constantly to build EMPERIA 1900, enabled with “Smart
            Micellar Technology” in providing effective and innovative hygiene
            care solutions that in turn enable individuals and communities to
            maintain a clean and healthy living. We are guided by our principles
            such as a customer centric approach, passion & integrity and
            continuous improvement & innovation. We have leveraged our decades
            of experience in research and development to create products that
            are safe, effective and easy to use. <br /> Emperia 1900 is steadfastly
            committed to improving and carefully formulating solutions to meet
